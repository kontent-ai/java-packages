package kontent.ai.sample.android.kotlin.app.articles
...
import kontent.ai.sample.android.kotlin.R
...
class ArticlesAdapter(private val context: Context,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        postDateTextView.text = article.publishingDate.format(formatter)
        summaryTextView.text = article.subtitle
